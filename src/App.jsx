...
function App() {
  ...
  return (
    <>
      <div className='container d-flex justify-content-center align-items-center container-size' style={{ backgroundColor: color }}>
        <div className='card border clamp-card'>
          <div className='card-body'>
            <h1 className='card-title text-center quote-size' style={{ color: color }}>
            ...
            <p className='card-text text-end' style={{ color: color }}>- { author }</p>
            <div className='d-flex align-items-center justify-content-between'>
              <div>
                <a href="#" className='card-link'>Link</a>
                <a href="#" className='card-link'>Link</a>                
              </div>
              <button type='button' className='btn' style={{ backgroundColor: color, color: "#ffffff" }} onClick={fetchQuote}>Next</button>
            </div>
          </div>
        </div>
      </div>
